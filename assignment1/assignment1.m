...
helpURL = 'https://www.mathworks.com/help/index.html?s_tid=CRUX_lftnav'; 

% 2. What does the command 'clear all' do?
% 
% Answer: It clears the variables in the workspace.
%
...
%
% Answer: The aov(y) performs a one-way ANOVA test. I would use it if I
% had two plots and wanted to compare the x values.
%
...
%
% Answer: There is the 'For' and 'While' statements. The 'For' statement
% loops for a certain number of times and the 'While' statement loops as
...
%
% Answer: It stands for Not a Number. This might come up in answer if you
% enter an equation that is not solvable. For example, 1/0.
% 
% 
%
...
vecLessThree = originalVec - 3;

% - count how many are positive
posVec= sum(originalVec > 0);

% - get the absolute value of each element
abVec = abs(originalVec);


% - find the maximum.
maVec = max(originalVec);
...
% This code uses the formula for the area of a trapezoid. It adds the two
% bases together and then divides it by two. The quotient is then
...
% ROI.
totalRevenues = input ('input totalRevenues:');
totalCosts = input ('input totalCosts:');
...
usertext= input ('enter any text', 's');
disp (usertext)
